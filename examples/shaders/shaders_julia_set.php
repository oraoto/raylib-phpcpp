...
$shader = LoadShader(0, __DIR__ . "/resources/shaders/glsl330/julia_set.fs", 330);
...
SetShaderValue($shader, GetShaderLocation($shader, "screenDims"), pack('f2', ...$screenDims), UNIFORM_VEC2);

SetShaderValue($shader, $cLoc, pack('f2', ...$c), UNIFORM_VEC2);
SetShaderValue($shader, $zoomLoc, pack('f', $zoom), UNIFORM_FLOAT);
SetShaderValue($shader, $offsetLoc, pack('f2', ...$offset), UNIFORM_VEC2);
