...
PHPCPP_EXPORT void *get_module() {
    ...
    rlClass.method<&RL::IsWindowFullscreen>("IsWindowFullscreen");
    ...
    rlClass.method<&RL::GetWindowPosition>("GetWindowPosition");
    rlClass.method<&RL::GetMonitorName>("GetMonitorName");
    rlClass.method<&RL::GetClipboardText>("GetClipboardText");
    ...
    rlClass.method<&RL::GetCameraMatrix2D>("GetCameraMatrix2D");
    rlClass.method<&RL::GetWorldToScreen>("GetWorldToScreen");
    rlClass.method<&RL::GetWorldToScreenEx>("GetWorldToScreenEx");
    rlClass.method<&RL::GetWorldToScreen2D>("GetWorldToScreen2D");
    rlClass.method<&RL::GetScreenToWorld2D>("GetScreenToWorld2D");
    ...
    rlClass.method<&RL::ColorFromNormalized>("ColorFromNormalized");
    ...
    // LoadFileData is not supported
    rlClass.method<&RL::SaveFileData>("SaveFileData");
    rlClass.method<&RL::LoadFileText>("LoadFileText");
    rlClass.method<&RL::SaveFileText>("SaveFileText");
    rlClass.method<&RL::FileExists>("FileExists");
    rlClass.method<&RL::IsFileExtension>("IsFileExtension");
    rlClass.method<&RL::DirectoryExists>("DirectoryExists");
    rlClass.method<&RL::GetExtension>("GetExtension");
    rlClass.method<&RL::GetFileName>("GetFileName");
    rlClass.method<&RL::GetFileNameWithoutExt>("GetFileNameWithoutExt");
    rlClass.method<&RL::GetDirectoryPath>("GetDirectoryPath");
    rlClass.method<&RL::GetPrevDirectoryPath>("GetPrevDirectoryPath");
    rlClass.method<&RL::GetWorkingDirectory>("GetWorkingDirectory");
    // GetDirectoryFiles is not supported
    rlClass.method<&RL::ClearDirectoryFiles>("ClearDirectoryFiles");
    rlClass.method<&RL::ChangeDirectory>("ChangeDirectory");
    rlClass.method<&RL::IsFileDropped>("IsFileDropped");
    // GetDroppedFiles is not supported
    rlClass.method<&RL::ClearDroppedFiles>("ClearDroppedFiles");
    rlClass.method<&RL::GetFileModTime>("GetFileModTime");
    // CompressData is not supported
    // DecompressData is not supported
    rlClass.method<&RL::SaveStorageValue>("SaveStorageValue");
    rlClass.method<&RL::LoadStorageValue>("LoadStorageValue");
    ...
    rlClass.method<&RL::GetGamepadName>("GetGamepadName");
    ...
    rlClass.method<&RL::SetCameraSmoothZoomControl>(
    ...
    rlClass.method<&RL::DrawLineStrip>("DrawLineStrip");
    ...
    rlClass.method<&RL::DrawEllipse>("DrawEllipse");
    rlClass.method<&RL::DrawEllipseLines>("DrawEllipseLines");
    ...
    rlClass.method<&RL::DrawTriangleFan>("DrawTriangleFan");
    rlClass.method<&RL::DrawTriangleStrip>("DrawTriangleStrip");
    rlClass.method<&RL::DrawPoly>("DrawPoly");
    rlClass.method<&RL::DrawPolyLines>("DrawPolyLines");
    ...
    rlClass.method<&RL::LoadImagePro>("LoadImagePro");
    ...
    rlClass.method<&RL::ImageFromImage>("ImageFromImage");
    ...
    // ImageExtractPalette is not supported
    rlClass.method<&RL::GetImageAlphaBorder>("GetImageAlphaBorder");
    rlClass.method<&RL::ImageClearBackground>("ImageClearBackground");
    rlClass.method<&RL::ImageDrawPixel>("ImageDrawPixel");
    rlClass.method<&RL::ImageDrawPixelV>("ImageDrawPixelV");
    rlClass.method<&RL::ImageDrawLine>("ImageDrawLine");
    rlClass.method<&RL::ImageDrawLineV>("ImageDrawLineV");
    rlClass.method<&RL::ImageDrawCircle>("ImageDrawCircle");
    rlClass.method<&RL::ImageDrawCircleV>("ImageDrawCircleV");
    rlClass.method<&RL::ImageDrawRectangle>("ImageDrawRectangle");
    rlClass.method<&RL::ImageDrawRectangleV>("ImageDrawRectangleV");
    rlClass.method<&RL::ImageDrawRectangleRec>("ImageDrawRectangleRec");
    ...
    rlClass.method<&RL::UpdateTexture>("UpdateTexture");
    ...
    // rlClass.method<&RL::LoadFontEx>("LoadFontEx");
    ...
    rlClass.method<&RL::DrawTextCodepoint>("DrawTextCodepoint");
    ...
    // rlClass.method<&RL::TextCopy>("TextCopy");
    // rlClass.method<&RL::TextIsEqual>("TextIsEqual");
    rlClass.method<&RL::TextLength>("TextLength");
    rlClass.method<&RL::TextFormat>("TextFormat");
    rlClass.method<&RL::TextSubtext>("TextSubtext");
    // rlClass.method<&RL::TextReplace>("TextReplace");
    rlClass.method<&RL::TextInsert>("TextInsert");
    // rlClass.method<&RL::TextJoin>("TextJoin");
    // TextSplit is not supported
    // rlClass.method<&RL::TextAppend>("TextAppend");
    rlClass.method<&RL::TextFindIndex>("TextFindIndex");
    rlClass.method<&RL::TextToUpper>("TextToUpper");
    rlClass.method<&RL::TextToLower>("TextToLower");
    rlClass.method<&RL::TextToPascal>("TextToPascal");
    rlClass.method<&RL::TextToInteger>("TextToInteger");
    // rlClass.method<&RL::TextToUtf8>("TextToUtf8");
    // GetCodepoints is not supported
    rlClass.method<&RL::GetCodepointsCount>("GetCodepointsCount");
    // rlClass.method<&RL::GetNextCodepoint>("GetNextCodepoint");
    // rlClass.method<&RL::CodepointToUtf8>("CodepointToUtf8");
    rlClass.method<&RL::DrawLine3D>("DrawLine3D");
    rlClass.method<&RL::DrawPoint3D>("DrawPoint3D");
    ...
    rlClass.method<&RL::LoadShaderCode>("LoadShaderCode");
    ...
    rlClass.method<&RL::GetShapesTexture>("GetShapesTexture");
    rlClass.method<&RL::GetShapesTextureRec>("GetShapesTextureRec");
    rlClass.method<&RL::SetShapesTexture>("SetShapesTexture");
    rlClass.method<&RL::GetShaderLocation>("GetShaderLocation");
    rlClass.method<&RL::SetShaderValue>("SetShaderValue");
    rlClass.method<&RL::SetShaderValueV>("SetShaderValueV");
    ...
    rlClass.method<&RL::GetMatrixProjection>("GetMatrixProjection");
    ...
    rlClass.method<&RL::UpdateSound>("UpdateSound");
    ...
    rlClass.method<&RL::UpdateAudioStream>("UpdateAudioStream");
    ...
    rlClass.method<&RL::SetAudioStreamBufferSizeDefault>(
    ...
    rlClass.method<&RL::createCharInfo>("CharInfo");
    ...
    // rlClass.method<&RL::createrAudioBuffer>("rAudioBuffer");
    rlClass.method<&RL::createSound>("Sound");
    rlClass.property("FLAG_RESERVED", 1, Php::Const);
    ...
    rlClass.property("FLAG_WINDOW_ALWAYS_RUN", 256, Php::Const);
    ...
    rlClass.property("GAMEPAD_BUTTON_UNKNOWN", 0, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_FACE_UP", 1, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_FACE_RIGHT", 2, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_FACE_DOWN", 3, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_FACE_LEFT", 4, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_FACE_UP", 5, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_FACE_RIGHT", 6, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_FACE_DOWN", 7, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_FACE_LEFT", 8, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_TRIGGER_1", 9, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_TRIGGER_2", 10, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_TRIGGER_1", 11, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_TRIGGER_2", 12, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_MIDDLE_LEFT", 13, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_MIDDLE", 14, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_MIDDLE_RIGHT", 15, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_LEFT_THUMB", 16, Php::Const);
    rlClass.property("GAMEPAD_BUTTON_RIGHT_THUMB", 17, Php::Const);
    rlClass.property("GAMEPAD_AXIS_UNKNOWN", 0, Php::Const);
    rlClass.property("GAMEPAD_AXIS_LEFT_X", 1, Php::Const);
    rlClass.property("GAMEPAD_AXIS_LEFT_Y", 2, Php::Const);
    rlClass.property("GAMEPAD_AXIS_RIGHT_X", 3, Php::Const);
    rlClass.property("GAMEPAD_AXIS_RIGHT_Y", 4, Php::Const);
    rlClass.property("GAMEPAD_AXIS_LEFT_TRIGGER", 5, Php::Const);
    rlClass.property("GAMEPAD_AXIS_RIGHT_TRIGGER", 6, Php::Const);
