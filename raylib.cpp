...
PHPCPP_EXPORT void *get_module() {
    ...
    extension.add(Php::Constant("FLAG_RESERVED", 1));
    extension.add(Php::Constant("FLAG_FULLSCREEN_MODE", 2));
    extension.add(Php::Constant("FLAG_WINDOW_RESIZABLE", 4));
    extension.add(Php::Constant("FLAG_WINDOW_UNDECORATED", 8));
    extension.add(Php::Constant("FLAG_WINDOW_TRANSPARENT", 16));
    extension.add(Php::Constant("FLAG_WINDOW_HIDDEN", 128));
    extension.add(Php::Constant("FLAG_WINDOW_ALWAYS_RUN", 256));
    extension.add(Php::Constant("FLAG_MSAA_4X_HINT", 32));
    extension.add(Php::Constant("FLAG_VSYNC_HINT", 64));
    extension.add(Php::Constant("LOG_ALL", 0));
    extension.add(Php::Constant("LOG_TRACE", 1));
    extension.add(Php::Constant("LOG_DEBUG", 2));
    extension.add(Php::Constant("LOG_INFO", 3));
    extension.add(Php::Constant("LOG_WARNING", 4));
    extension.add(Php::Constant("LOG_ERROR", 5));
    extension.add(Php::Constant("LOG_FATAL", 6));
    extension.add(Php::Constant("LOG_NONE", 7));
    extension.add(Php::Constant("KEY_APOSTROPHE", 39));
    extension.add(Php::Constant("KEY_COMMA", 44));
    extension.add(Php::Constant("KEY_MINUS", 45));
    extension.add(Php::Constant("KEY_PERIOD", 46));
    extension.add(Php::Constant("KEY_SLASH", 47));
    extension.add(Php::Constant("KEY_ZERO", 48));
    extension.add(Php::Constant("KEY_ONE", 49));
    extension.add(Php::Constant("KEY_TWO", 50));
    extension.add(Php::Constant("KEY_THREE", 51));
    extension.add(Php::Constant("KEY_FOUR", 52));
    extension.add(Php::Constant("KEY_FIVE", 53));
    extension.add(Php::Constant("KEY_SIX", 54));
    extension.add(Php::Constant("KEY_SEVEN", 55));
    extension.add(Php::Constant("KEY_EIGHT", 56));
    extension.add(Php::Constant("KEY_NINE", 57));
    extension.add(Php::Constant("KEY_SEMICOLON", 59));
    extension.add(Php::Constant("KEY_EQUAL", 61));
    extension.add(Php::Constant("KEY_A", 65));
    extension.add(Php::Constant("KEY_B", 66));
    extension.add(Php::Constant("KEY_C", 67));
    extension.add(Php::Constant("KEY_D", 68));
    extension.add(Php::Constant("KEY_E", 69));
    extension.add(Php::Constant("KEY_F", 70));
    extension.add(Php::Constant("KEY_G", 71));
    extension.add(Php::Constant("KEY_H", 72));
    extension.add(Php::Constant("KEY_I", 73));
    extension.add(Php::Constant("KEY_J", 74));
    extension.add(Php::Constant("KEY_K", 75));
    extension.add(Php::Constant("KEY_L", 76));
    extension.add(Php::Constant("KEY_M", 77));
    extension.add(Php::Constant("KEY_N", 78));
    extension.add(Php::Constant("KEY_O", 79));
    extension.add(Php::Constant("KEY_P", 80));
    extension.add(Php::Constant("KEY_Q", 81));
    extension.add(Php::Constant("KEY_R", 82));
    extension.add(Php::Constant("KEY_S", 83));
    extension.add(Php::Constant("KEY_T", 84));
    extension.add(Php::Constant("KEY_U", 85));
    extension.add(Php::Constant("KEY_V", 86));
    extension.add(Php::Constant("KEY_W", 87));
    extension.add(Php::Constant("KEY_X", 88));
    extension.add(Php::Constant("KEY_Y", 89));
    extension.add(Php::Constant("KEY_Z", 90));
    extension.add(Php::Constant("KEY_SPACE", 32));
    extension.add(Php::Constant("KEY_ESCAPE", 256));
    extension.add(Php::Constant("KEY_ENTER", 257));
    extension.add(Php::Constant("KEY_TAB", 258));
    extension.add(Php::Constant("KEY_BACKSPACE", 259));
    extension.add(Php::Constant("KEY_INSERT", 260));
    extension.add(Php::Constant("KEY_DELETE", 261));
    extension.add(Php::Constant("KEY_RIGHT", 262));
    extension.add(Php::Constant("KEY_LEFT", 263));
    extension.add(Php::Constant("KEY_DOWN", 264));
    extension.add(Php::Constant("KEY_UP", 265));
    extension.add(Php::Constant("KEY_PAGE_UP", 266));
    extension.add(Php::Constant("KEY_PAGE_DOWN", 267));
    extension.add(Php::Constant("KEY_HOME", 268));
    extension.add(Php::Constant("KEY_END", 269));
    extension.add(Php::Constant("KEY_CAPS_LOCK", 280));
    extension.add(Php::Constant("KEY_SCROLL_LOCK", 281));
    extension.add(Php::Constant("KEY_NUM_LOCK", 282));
    extension.add(Php::Constant("KEY_PRINT_SCREEN", 283));
    extension.add(Php::Constant("KEY_PAUSE", 284));
    extension.add(Php::Constant("KEY_F1", 290));
    extension.add(Php::Constant("KEY_F2", 291));
    extension.add(Php::Constant("KEY_F3", 292));
    extension.add(Php::Constant("KEY_F4", 293));
    extension.add(Php::Constant("KEY_F5", 294));
    extension.add(Php::Constant("KEY_F6", 295));
    extension.add(Php::Constant("KEY_F7", 296));
    extension.add(Php::Constant("KEY_F8", 297));
    extension.add(Php::Constant("KEY_F9", 298));
    extension.add(Php::Constant("KEY_F10", 299));
    extension.add(Php::Constant("KEY_F11", 300));
    extension.add(Php::Constant("KEY_F12", 301));
    extension.add(Php::Constant("KEY_LEFT_SHIFT", 340));
    extension.add(Php::Constant("KEY_LEFT_CONTROL", 341));
    extension.add(Php::Constant("KEY_LEFT_ALT", 342));
    extension.add(Php::Constant("KEY_LEFT_SUPER", 343));
    extension.add(Php::Constant("KEY_RIGHT_SHIFT", 344));
    extension.add(Php::Constant("KEY_RIGHT_CONTROL", 345));
    extension.add(Php::Constant("KEY_RIGHT_ALT", 346));
    extension.add(Php::Constant("KEY_RIGHT_SUPER", 347));
    extension.add(Php::Constant("KEY_KB_MENU", 348));
    extension.add(Php::Constant("KEY_LEFT_BRACKET", 91));
    extension.add(Php::Constant("KEY_BACKSLASH", 92));
    extension.add(Php::Constant("KEY_RIGHT_BRACKET", 93));
    extension.add(Php::Constant("KEY_GRAVE", 96));
    extension.add(Php::Constant("KEY_KP_0", 320));
    extension.add(Php::Constant("KEY_KP_1", 321));
    extension.add(Php::Constant("KEY_KP_2", 322));
    extension.add(Php::Constant("KEY_KP_3", 323));
    extension.add(Php::Constant("KEY_KP_4", 324));
    extension.add(Php::Constant("KEY_KP_5", 325));
    extension.add(Php::Constant("KEY_KP_6", 326));
    extension.add(Php::Constant("KEY_KP_7", 327));
    extension.add(Php::Constant("KEY_KP_8", 328));
    extension.add(Php::Constant("KEY_KP_9", 329));
    extension.add(Php::Constant("KEY_KP_DECIMAL", 330));
    extension.add(Php::Constant("KEY_KP_DIVIDE", 331));
    extension.add(Php::Constant("KEY_KP_MULTIPLY", 332));
    extension.add(Php::Constant("KEY_KP_SUBTRACT", 333));
    extension.add(Php::Constant("KEY_KP_ADD", 334));
    extension.add(Php::Constant("KEY_KP_ENTER", 335));
    extension.add(Php::Constant("KEY_KP_EQUAL", 336));
    extension.add(Php::Constant("KEY_BACK", 4));
    extension.add(Php::Constant("KEY_MENU", 82));
    extension.add(Php::Constant("KEY_VOLUME_UP", 24));
    extension.add(Php::Constant("KEY_VOLUME_DOWN", 25));
    extension.add(Php::Constant("MOUSE_LEFT_BUTTON", 0));
    extension.add(Php::Constant("MOUSE_RIGHT_BUTTON", 1));
    extension.add(Php::Constant("MOUSE_MIDDLE_BUTTON", 2));
    extension.add(Php::Constant("GAMEPAD_PLAYER1", 0));
    extension.add(Php::Constant("GAMEPAD_PLAYER2", 1));
    extension.add(Php::Constant("GAMEPAD_PLAYER3", 2));
    extension.add(Php::Constant("GAMEPAD_PLAYER4", 3));
    extension.add(Php::Constant("GAMEPAD_BUTTON_UNKNOWN", 0));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_FACE_UP", 1));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_FACE_RIGHT", 2));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_FACE_DOWN", 3));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_FACE_LEFT", 4));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_FACE_UP", 5));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_FACE_RIGHT", 6));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_FACE_DOWN", 7));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_FACE_LEFT", 8));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_TRIGGER_1", 9));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_TRIGGER_2", 10));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_TRIGGER_1", 11));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_TRIGGER_2", 12));
    extension.add(Php::Constant("GAMEPAD_BUTTON_MIDDLE_LEFT", 13));
    extension.add(Php::Constant("GAMEPAD_BUTTON_MIDDLE", 14));
    extension.add(Php::Constant("GAMEPAD_BUTTON_MIDDLE_RIGHT", 15));
    extension.add(Php::Constant("GAMEPAD_BUTTON_LEFT_THUMB", 16));
    extension.add(Php::Constant("GAMEPAD_BUTTON_RIGHT_THUMB", 17));
    extension.add(Php::Constant("GAMEPAD_AXIS_UNKNOWN", 0));
    extension.add(Php::Constant("GAMEPAD_AXIS_LEFT_X", 1));
    extension.add(Php::Constant("GAMEPAD_AXIS_LEFT_Y", 2));
    extension.add(Php::Constant("GAMEPAD_AXIS_RIGHT_X", 3));
    extension.add(Php::Constant("GAMEPAD_AXIS_RIGHT_Y", 4));
    extension.add(Php::Constant("GAMEPAD_AXIS_LEFT_TRIGGER", 5));
    extension.add(Php::Constant("GAMEPAD_AXIS_RIGHT_TRIGGER", 6));
    extension.add(Php::Constant("LOC_VERTEX_POSITION", 0));
    extension.add(Php::Constant("LOC_VERTEX_TEXCOORD01", 1));
    extension.add(Php::Constant("LOC_VERTEX_TEXCOORD02", 2));
    extension.add(Php::Constant("LOC_VERTEX_NORMAL", 3));
    extension.add(Php::Constant("LOC_VERTEX_TANGENT", 4));
    extension.add(Php::Constant("LOC_VERTEX_COLOR", 5));
    extension.add(Php::Constant("LOC_MATRIX_MVP", 6));
    extension.add(Php::Constant("LOC_MATRIX_MODEL", 7));
    extension.add(Php::Constant("LOC_MATRIX_VIEW", 8));
    extension.add(Php::Constant("LOC_MATRIX_PROJECTION", 9));
    extension.add(Php::Constant("LOC_VECTOR_VIEW", 10));
    extension.add(Php::Constant("LOC_COLOR_DIFFUSE", 11));
    extension.add(Php::Constant("LOC_COLOR_SPECULAR", 12));
    extension.add(Php::Constant("LOC_COLOR_AMBIENT", 13));
    extension.add(Php::Constant("LOC_MAP_ALBEDO", 14));
    extension.add(Php::Constant("LOC_MAP_METALNESS", 15));
    extension.add(Php::Constant("LOC_MAP_NORMAL", 16));
    extension.add(Php::Constant("LOC_MAP_ROUGHNESS", 17));
    extension.add(Php::Constant("LOC_MAP_OCCLUSION", 18));
    extension.add(Php::Constant("LOC_MAP_EMISSION", 19));
    extension.add(Php::Constant("LOC_MAP_HEIGHT", 20));
    extension.add(Php::Constant("LOC_MAP_CUBEMAP", 21));
    extension.add(Php::Constant("LOC_MAP_IRRADIANCE", 22));
    extension.add(Php::Constant("LOC_MAP_PREFILTER", 23));
    extension.add(Php::Constant("LOC_MAP_BRDF", 24));
    extension.add(Php::Constant("UNIFORM_FLOAT", 0));
    extension.add(Php::Constant("UNIFORM_VEC2", 1));
    extension.add(Php::Constant("UNIFORM_VEC3", 2));
    extension.add(Php::Constant("UNIFORM_VEC4", 3));
    extension.add(Php::Constant("UNIFORM_INT", 4));
    extension.add(Php::Constant("UNIFORM_IVEC2", 5));
    extension.add(Php::Constant("UNIFORM_IVEC3", 6));
    extension.add(Php::Constant("UNIFORM_IVEC4", 7));
    extension.add(Php::Constant("UNIFORM_SAMPLER2D", 8));
    extension.add(Php::Constant("MAP_ALBEDO", 0));
    extension.add(Php::Constant("MAP_METALNESS", 1));
    extension.add(Php::Constant("MAP_NORMAL", 2));
    extension.add(Php::Constant("MAP_ROUGHNESS", 3));
    extension.add(Php::Constant("MAP_OCCLUSION", 4));
    extension.add(Php::Constant("MAP_EMISSION", 5));
    extension.add(Php::Constant("MAP_HEIGHT", 6));
    extension.add(Php::Constant("MAP_CUBEMAP", 7));
    extension.add(Php::Constant("MAP_IRRADIANCE", 8));
    extension.add(Php::Constant("MAP_PREFILTER", 9));
    extension.add(Php::Constant("MAP_BRDF", 10));
    extension.add(Php::Constant("UNCOMPRESSED_GRAYSCALE", 1));
    extension.add(Php::Constant("UNCOMPRESSED_GRAY_ALPHA", 2));
    extension.add(Php::Constant("UNCOMPRESSED_R5G6B5", 3));
    extension.add(Php::Constant("UNCOMPRESSED_R8G8B8", 4));
    extension.add(Php::Constant("UNCOMPRESSED_R5G5B5A1", 5));
    extension.add(Php::Constant("UNCOMPRESSED_R4G4B4A4", 6));
    extension.add(Php::Constant("UNCOMPRESSED_R8G8B8A8", 7));
    extension.add(Php::Constant("UNCOMPRESSED_R32", 8));
    extension.add(Php::Constant("UNCOMPRESSED_R32G32B32", 9));
    extension.add(Php::Constant("UNCOMPRESSED_R32G32B32A32", 10));
    extension.add(Php::Constant("COMPRESSED_DXT1_RGB", 11));
    extension.add(Php::Constant("COMPRESSED_DXT1_RGBA", 12));
    extension.add(Php::Constant("COMPRESSED_DXT3_RGBA", 13));
    extension.add(Php::Constant("COMPRESSED_DXT5_RGBA", 14));
    extension.add(Php::Constant("COMPRESSED_ETC1_RGB", 15));
    extension.add(Php::Constant("COMPRESSED_ETC2_RGB", 16));
    extension.add(Php::Constant("COMPRESSED_ETC2_EAC_RGBA", 17));
    extension.add(Php::Constant("COMPRESSED_PVRT_RGB", 18));
    extension.add(Php::Constant("COMPRESSED_PVRT_RGBA", 19));
    extension.add(Php::Constant("COMPRESSED_ASTC_4x4_RGBA", 20));
    extension.add(Php::Constant("COMPRESSED_ASTC_8x8_RGBA", 21));
    extension.add(Php::Constant("FILTER_POINT", 0));
    extension.add(Php::Constant("FILTER_BILINEAR", 1));
    extension.add(Php::Constant("FILTER_TRILINEAR", 2));
    extension.add(Php::Constant("FILTER_ANISOTROPIC_4X", 3));
    extension.add(Php::Constant("FILTER_ANISOTROPIC_8X", 4));
    extension.add(Php::Constant("FILTER_ANISOTROPIC_16X", 5));
    extension.add(Php::Constant("CUBEMAP_AUTO_DETECT", 0));
    extension.add(Php::Constant("CUBEMAP_LINE_VERTICAL", 1));
    extension.add(Php::Constant("CUBEMAP_LINE_HORIZONTAL", 2));
    extension.add(Php::Constant("CUBEMAP_CROSS_THREE_BY_FOUR", 3));
    extension.add(Php::Constant("CUBEMAP_CROSS_FOUR_BY_THREE", 4));
    extension.add(Php::Constant("CUBEMAP_PANORAMA", 5));
    extension.add(Php::Constant("WRAP_REPEAT", 0));
    extension.add(Php::Constant("WRAP_CLAMP", 1));
    extension.add(Php::Constant("WRAP_MIRROR_REPEAT", 2));
    extension.add(Php::Constant("WRAP_MIRROR_CLAMP", 3));
    extension.add(Php::Constant("FONT_DEFAULT", 0));
    extension.add(Php::Constant("FONT_BITMAP", 1));
    extension.add(Php::Constant("FONT_SDF", 2));
    extension.add(Php::Constant("BLEND_ALPHA", 0));
    extension.add(Php::Constant("BLEND_ADDITIVE", 1));
    extension.add(Php::Constant("BLEND_MULTIPLIED", 2));
    extension.add(Php::Constant("GESTURE_NONE", 0));
    extension.add(Php::Constant("GESTURE_TAP", 1));
    extension.add(Php::Constant("GESTURE_DOUBLETAP", 2));
    extension.add(Php::Constant("GESTURE_HOLD", 4));
    extension.add(Php::Constant("GESTURE_DRAG", 8));
    extension.add(Php::Constant("GESTURE_SWIPE_RIGHT", 16));
    extension.add(Php::Constant("GESTURE_SWIPE_LEFT", 32));
    extension.add(Php::Constant("GESTURE_SWIPE_UP", 64));
    extension.add(Php::Constant("GESTURE_SWIPE_DOWN", 128));
    extension.add(Php::Constant("GESTURE_PINCH_IN", 256));
    extension.add(Php::Constant("GESTURE_PINCH_OUT", 512));
    extension.add(Php::Constant("CAMERA_CUSTOM", 0));
    extension.add(Php::Constant("CAMERA_FREE", 1));
    extension.add(Php::Constant("CAMERA_ORBITAL", 2));
    extension.add(Php::Constant("CAMERA_FIRST_PERSON", 3));
    extension.add(Php::Constant("CAMERA_THIRD_PERSON", 4));
    extension.add(Php::Constant("CAMERA_PERSPECTIVE", 0));
    extension.add(Php::Constant("CAMERA_ORTHOGRAPHIC", 1));
    extension.add(Php::Constant("NPT_9PATCH", 0));
    extension.add(Php::Constant("NPT_3PATCH_VERTICAL", 1));
    extension.add(Php::Constant("NPT_3PATCH_HORIZONTAL", 2));
